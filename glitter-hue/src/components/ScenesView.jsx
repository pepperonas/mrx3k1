    ...
    return (
        <div className={`scene-icon ${isActive ? 'active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                {iconPath === 'sunset' && (
                    <>
                        <path d="M12 9V2M4.2 15.2L5.6 13.8M19.8 15.2L18.4 13.8M2 21H22M5.6 18.8L4.2 17.4M19.8 17.4L18.4 18.8M12 13V9" />
...
const SceneCard = ({ scene, onActivate, onEdit, onDelete }) => {
    return (
        <div className={`scene-card ${scene.isActive ? 'active' : ''}`} onClick={() => onActivate(scene.id)}>
    ...
    return (
        <div className="scenes-view">
            <div className="scenes-header">
                ...
                <button onClick={() => { setEditingScene(null); setShowFormModal(true); }}>
            ...
            {showFormModal && (
                <SceneFormModal
                    ...
                    lights={lights}
                    onSave={saveScene}
                    onCancel={() => { setShowFormModal(false); setEditingScene(null); }}
                />
            )}
        </div>
    );
