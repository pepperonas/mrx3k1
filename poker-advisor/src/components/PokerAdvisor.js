...
const PokerAdvisor = () => {
    ...
    const [showHandsAccordion, setShowHandsAccordion] = useState(false);
    ...
    return (
        <div className="poker-container">
                            ...
                            <div className="position-table">
                                ...
                                {positions.map(pos => (
                                    ...
                                    >
                                        ...
                                        <div
                                            className={`position-cell action ${result.decisionByPosition[pos].decision}`}>
            ...
            {/* Poker Hands Accordion */}
            <div className="poker-hands-accordion">
                <div
                    className="accordion-header"
                    onClick={() => setShowHandsAccordion(!showHandsAccordion)}
                >
                    <span>Poker-Blätter Übersicht</span>
                    <span className="accordion-icon">{showHandsAccordion ? '▲' : '▼'}</span>
                </div>

                {showHandsAccordion && (
                    <div className="accordion-content">
                        <div className="hand-category">
                            <div className="hand-title">Royal Flush</div>
                            <div className="hand-description">10, J, Q, K, A der gleichen Farbe
                            </div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display red">A♥</span> <span
                                className="card-display red">K♥</span> <span
                                className="card-display red">Q♥</span> <span
                                className="card-display red">J♥</span> <span
                                className="card-display red">10♥</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Straight Flush</div>
                            <div className="hand-description">Fünf aufeinanderfolgende Karten der
                                gleichen Farbe
                            </div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display">9♠</span> <span
                                className="card-display">8♠</span> <span
                                className="card-display">7♠</span> <span
                                className="card-display">6♠</span> <span
                                className="card-display">5♠</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Four of a Kind</div>
                            <div className="hand-description">Vier Karten mit gleichem Wert</div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display red">K♥</span> <span
                                className="card-display">K♠</span> <span
                                className="card-display red">K♦</span> <span
                                className="card-display">K♣</span> <span
                                className="card-display red">7♥</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Full House</div>
                            <div className="hand-description">Drilling + Paar</div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display red">J♥</span> <span
                                className="card-display">J♣</span> <span
                                className="card-display">J♠</span> <span
                                className="card-display red">8♦</span> <span
                                className="card-display red">8♥</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Flush</div>
                            <div className="hand-description">Fünf Karten der gleichen Farbe</div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display red">A♦</span> <span
                                className="card-display red">J♦</span> <span
                                className="card-display red">8♦</span> <span
                                className="card-display red">5♦</span> <span
                                className="card-display red">2♦</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Straight</div>
                            <div className="hand-description">Fünf aufeinanderfolgende Karten
                                (verschiedene Farben)
                            </div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display">9♣</span> <span
                                className="card-display red">8♥</span> <span
                                className="card-display">7♠</span> <span
                                className="card-display red">6♦</span> <span
                                className="card-display">5♣</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Three of a Kind</div>
                            <div className="hand-description">Drei Karten mit gleichem Wert</div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display">Q♠</span> <span
                                className="card-display red">Q♥</span> <span
                                className="card-display red">Q♦</span> <span
                                className="card-display">9♣</span> <span
                                className="card-display">2♠</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Two Pair</div>
                            <div className="hand-description">Zwei verschiedene Paare</div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display red">A♥</span> <span
                                className="card-display">A♣</span> <span
                                className="card-display red">10♦</span> <span
                                className="card-display">10♠</span> <span
                                className="card-display red">9♥</span>
                            </div>
                        </div>

                        <div className="hand-category">
                            <div className="hand-title">Pair</div>
                            <div className="hand-description">Zwei Karten mit gleichem Wert</div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display red">10♥</span> <span
                                className="card-display">10♠</span> <span
                                className="card-display red">K♦</span> <span
                                className="card-display">6♣</span> <span
                                className="card-display red">2♥</span>
                        ...
                        <div className="hand-category">
                            <div className="hand-title">High Card</div>
                            <div className="hand-description">Keine der obigen Kombinationen,
                                höchste Karte zählt
                            </div>
                            <div className="hand-example">
                                Beispiel: <span className="card-display">A♠</span> <span
                                className="card-display red">J♥</span> <span
                                className="card-display red">8♦</span> <span
                                className="card-display">6♣</span> <span
                                className="card-display">4♠</span>
                            </div>
                        </div>
                    </div>
                )}
